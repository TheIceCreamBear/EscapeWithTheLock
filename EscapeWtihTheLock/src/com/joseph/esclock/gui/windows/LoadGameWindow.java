...
public class LoadGameWindow extends Window {
	...
	public LoadGameWindow(File[] files) {
		...
		maxL *= ScreenReference.CHAR_WIDTH;
		maxL += 15;
		int h = ((int) r.getHeight() + 12) * (files.length + 1);
...
//		super.resetDimensions(600, 400, maxL, h, true);
		super.resetDimensions(1100, ScreenReference.HEIGHT / 2 - (h / 2), maxL, h, true);
